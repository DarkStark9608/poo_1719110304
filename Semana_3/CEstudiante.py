...
class CUniversitario(CEstudiante):
  ...
  def universidadOnline(self):
    print("El estudiante: "+self.nombreEstudiante +"self.apellidoPaterno"+ " "+self.apellidoMaterno+" esta online.")
...
objCUniversitario.universidadOnline()
