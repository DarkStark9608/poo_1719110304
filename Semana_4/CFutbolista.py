class CFutbolista:
  ...
  def jugarFutbol(self):
    print("El estudiante: "+self.nombreFutbolista+" " +self.apellidoPaternoFutbolista+" "+self.apellidoMaternoFutbolista+" esta jugando futbol. \n")
...
class CFutbolistaJR(CFutbolista):
  ...
  def jugarFutbol(self):
    print("El estudiante: "+self.nombreFutbolista +" esta jugando futbol de a coca \n")
